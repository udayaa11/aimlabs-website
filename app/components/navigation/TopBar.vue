    ...
    <div class="fixed top-0 left-0 w-full h-[84px] bg-white z-50 shadow-md border-b-2">
      <div class="h-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-[120px] flex items-center justify-between">
        <NuxtLink to="/" @click="closeDropdown">
          <img src="/assets/svg/aimlabsLogo.svg" alt="Aimlabs Logo" class="cursor-pointer" />
        </NuxtLink>
        <!-- Desktop Navigation -->
        <div class="hidden lg:flex gap-10 text-gray-800 text-sm font-medium">
          <div class="relative cursor-pointer" @mouseenter="activeDropdown = 'what'">
            <div class="flex gap-2 items-center">
              ...
              <img src="/assets/svg/dropdownIcon.svg"
          ...
          <NuxtLink to="/careers/career"
            ...
            active-class="text-red-600 underline underline-offset-4"
            exact-active-class="text-red-600 underline underline-offset-4">
            Careers
          </NuxtLink>
        </div>
        ...
        <div class="lg:hidden">
          <img src="/assets/svg/menu.svg" alt="Menu" class="cursor-pointer w-6 h-6" @click="toggleMobileMenu" />
        </div>
      </div>
    </div>
