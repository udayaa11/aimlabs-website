<template>
    <div class="w-full max-w-[1440px] px-[120px] mx-auto space-y-6 py-20">
        ...
        <div v-for="sec in terms.sections" :key="sec.heading" class="space-y-4 text-gray-600">
            ...
            <template v-if="isEmail(sec)">
                <div class="flex items-center gap-2">
                    ...
                    <a :href="`mailto:${sec.paragraph}`"
                        class="text-base text-red-600 font-semibold hover:underline">
                        {{ sec.paragraph }}
                    </a>
                </div>
            ...
            <template v-else>
                ...
                <div v-if="sec.paragraphs" class="space-y-3">
                    <p v-for="(para, i) in sec.paragraphs" :key="i" class="text-sm md:text-base text-gray-500">
                        {{ para }}
                    </p>
                </div>
...
import terms from '~/public/json/terms.json'
